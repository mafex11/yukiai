...
export default function Pricing() {
  return (
    <section id="pricing" className="w-full bg-zinc-950 py-24 sm:py-28 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <SectionHeader
            eyebrow="Pricing"
            title="There isn't any"
            sub="Yuki is free and MIT licensed. Bring an AI key — Gemini's free tier or local Ollama makes even that cost nothing."
          />
        </motion.div>

        <div className="flex justify-center px-4 sm:px-0">
          <motion.div
            className="rounded-3xl border border-[rgba(127,180,232,0.4)] backdrop-blur-2xl relative overflow-hidden w-full max-w-md group"
            ...
            style={{
              ...
              boxShadow:
                "0 20px 60px 0 rgba(0,0,0,0.6), 0 0 50px 15px rgba(127,180,232,0.35), inset 0 1px 0 0 rgba(255,255,255,0.1)",
            }}
          >
            <div
              ...
              style={{
                background:
                  "radial-gradient(ellipse 120% 90% at 50% 100%, rgba(127, 180, 232, 0.14), transparent 80%)",
              }}
            />
            <div className="relative z-10 flex flex-col px-6 py-8 sm:px-8 sm:py-10">
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.98 }}
                className="w-full rounded-full px-5 py-3 text-base sm:text-lg font-normal transition-all duration-300 mb-6 text-center block bg-zinc-950/10 text-white hover:bg-zinc-950/30 border border-white/30 shadow-lg shadow-[rgba(127,180,232,0.4)] hover:shadow-xl hover:shadow-[rgba(127,180,232,0.5)]"
              >
                Install Yuki
              </motion.a>
              ...
              <ul className="space-y-3">
                {features.map((feature, idx) => (
                  ...
                  >
                    <div className="mt-0.5 w-5 h-5 rounded-full bg-gradient-to-br from-zinc-800 to-zinc-900 border border-white/20 group-hover/item:border-[rgba(127,180,232,0.5)] flex items-center justify-center shrink-0 transition-all duration-300">
                      <Check className="w-3 h-3 text-white group-hover/item:text-[rgba(127,180,232,0.9)] transition-colors duration-300" />
                    </div>
